...
FORMLER = [
    ...
    {"navn": "Jævnt accelereret (1):  v = v₀ + a · t",         "side": "Kinematik",    "fil": "pages/1_Kinematik.py",        "key": "kin_formel",   "kw": "kinematik acceleration hastighed tid v v0 a t bremse bremsning opbremsning accelererer decelererer hvornår stopper ankommer",   "vars": ["v", "v₀", "a", "t"]},
    ...
    {"navn": "Friktion fra v-t-graf:  μ = |Δv/Δt| / g",          "side": "Dynamik",      "fil": "pages/2_Dynamik.py",          "key": "dyn_formel",   "kw": "friktion v-t graf deceleration mu kinetisk koefficient aflæs bremsning glider isen curling",        "vars": ["μ", "v", "t", "a", "g"]},
    ...
    {"navn": "Rulning uden glidning",                           "side": "Rotation",     "fil": "pages/9_Rotation.py",         "key": "rot_formel",   "kw": "rulning slip v omega r hastighed glidning ruller ned skråplan cylinder kugle ring bunden",         "vars": ["v", "ω", "R", "I", "m"]},
