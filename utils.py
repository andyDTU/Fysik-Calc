...
SEARCH_INDEX = [
    ...
    # Energi
    {"label": "Kinetisk energi › Energi", "page": "pages/3_Energi.py", "nav_key": "energi_formel", "nav_value": "Kinetisk energi:  Ek = ½ · m · v²", "keywords": ["kinetisk energi", "bevægelsesenergi", "Ek", "½mv2", "hastighed energi", "beregn energi"]},
    {"label": "Potentiel energi › Energi", "page": "pages/3_Energi.py", "nav_key": "energi_formel", "nav_value": "Potentiel energi:  Ep = m · g · h", "keywords": ["potentiel energi", "tyngdepotentiel", "Ep", "mgh", "højdeenergi", "gravitationsenergi"]},
    {"label": "Fjeder Hookes lov › Energi", "page": "pages/3_Energi.py", "nav_key": "energi_formel", "nav_value": "Fjederkraft og -energi", "keywords": ["fjeder", "fjederkonstant", "fjederkraft", "hookes lov", "forlængelse fjeder", "fjederstivhed", "elastisk"]},
    {"label": "Energibevarelse › Energi", "page": "pages/3_Energi.py", "nav_key": "energi_formel", "nav_value": "Energibevarelse:  Ek₁ + Ep₁ = Ek₂ + Ep₂", "keywords": ["energibevarelse", "mekanisk energi", "friktionsfri", "hastighed fra højde", "bevar energi", "konservativ"]},
    {"label": "Effekt › Energi", "page": "pages/3_Energi.py", "nav_key": "energi_formel", "nav_value": "Effekt:  P = W / t = F · v", "keywords": ["effekt", "watt", "P=Wt", "F·v kraft hastighed", "afsæt", "motor effekt"]},
    # Elektricitet
    {"label": "Ohms lov › Elektricitet", "page": "pages/4_Elektricitet.py", "nav_key": "el_formel", "nav_value": "Ohms lov:  U = R · I", "keywords": ["ohms lov", "spænding modstand strøm", "U=RI", "volt ampere ohm", "elektrisk kredsløb"]},
    {"label": "Seriekobling › Elektricitet", "page": "pages/4_Elektricitet.py", "nav_key": "el_formel", "nav_value": "Seriekobling af modstande", "keywords": ["seriekobling", "serie modstande", "total modstand serie", "modstande i serie"]},
    {"label": "Parallelkobling › Elektricitet", "page": "pages/4_Elektricitet.py", "nav_key": "el_formel", "nav_value": "Parallelkobling af modstande", "keywords": ["parallelkobling", "parallel modstande", "modstande parallel", "total modstand parallel"]},
    {"label": "Lorentzkraft › Elektricitet", "page": "pages/4_Elektricitet.py", "nav_key": "el_formel", "nav_value": "Lorentzkraft:  F = q · v · B", "keywords": ["lorentzkraft", "magnetfelt kraft", "ladning magnetfelt", "qvB", "kraft ladning", "magnetisk kraft"]},
    {"label": "Coulombs lov › Elektricitet", "page": "pages/4_Elektricitet.py", "nav_key": "el_formel", "nav_value": "Coulombs lov:  F = k · q₁ · q₂ / r²", "keywords": ["coulombs lov", "elektrisk kraft ladning", "tiltrækning frastødning", "coulomb", "ladning afstand"]},
    {"label": "Faradays lov › Elektricitet", "page": "pages/4_Elektricitet.py", "nav_key": "el_formel", "nav_value": "Faradays lov:  ε = -N · ΔΦ / Δt", "keywords": ["faradays lov", "induceret emf", "flux spole", "vindinger", "induktion", "elektromagnetisk induktion"]},
    # Bølger & Optik
    ...
    # Termodynamik
    {"label": "Ideel gaslov pV=nRT › Termodynamik", "page": "pages/6_Termodynamik.py", "nav_key": "termo_formel", "nav_value": "Ideel gaslov:  p · V = n · R · T", "keywords": ["ideel gaslov", "pV=nRT", "tryk volumen temperatur", "gas beregn", "stofmængde gas", "mol gas"]},
    {"label": "Kombineret gaslov › Termodynamik", "page": "pages/6_Termodynamik.py", "nav_key": "termo_formel", "nav_value": "Kombineret gaslov:  p₁V₁/T₁ = p₂V₂/T₂", "keywords": ["kombineret gaslov", "to tilstande gas", "p1V1/T1", "isoterm", "isobar", "isochor"]},
    {"label": "Varmekapacitet Q=mcΔT › Termodynamik", "page": "pages/6_Termodynamik.py", "nav_key": "termo_formel", "nav_value": "Varmekapacitet:  Q = m · c · ΔT", "keywords": ["varmekapacitet", "Q=mcΔT", "opvarmning afkøling", "spec varmekapacitet", "kalorimetri", "varme"]},
    {"label": "Faseovergang Q=mL › Termodynamik", "page": "pages/6_Termodynamik.py", "nav_key": "termo_formel", "nav_value": "Faseovergang:  Q = m · L", "keywords": ["faseovergang", "latent varme", "smeltning", "fordampning", "smeltevarme", "dampvarme", "fase"]},
    {"label": "Carnot-virkningsgrad › Termodynamik", "page": "pages/6_Termodynamik.py", "nav_key": "termo_formel", "nav_value": "Carnot-virkningsgrad:  η = 1 − Tk/Tv", "keywords": ["carnot", "virkningsgrad termodynamik", "varmepumpe", "varmemaskine", "nyttevirkningsgrad"]},
    # Atomfysik
    {"label": "Radioaktivt henfald › Atomfysik", "page": "pages/7_Atomfysik.py", "nav_key": "atom_formel", "nav_value": "Radioaktivt henfald:  N = N₀ · e^(−λt)", "keywords": ["radioaktivt henfald", "N=N0 exp", "henfaldskonstant", "radioaktivitet", "henfald"]},
    {"label": "Halvvejstid › Atomfysik", "page": "pages/7_Atomfysik.py", "nav_key": "atom_formel", "nav_value": "Halvvejstid:  T½ = ln(2) / λ", "keywords": ["halvvejstid", "T1/2", "halvt tilbage", "henfaldstid", "halverings"]},
    {"label": "E=mc² massedefekt › Atomfysik", "page": "pages/7_Atomfysik.py", "nav_key": "atom_formel", "nav_value": "Energi-masse:  E = Δm · c²", "keywords": ["E=mc2", "massedefekt", "kerneenergi", "kernefysik", "atommasseenhed", "fusion fission"]},
    {"label": "Fotonenergi E=hf › Atomfysik", "page": "pages/7_Atomfysik.py", "nav_key": "atom_formel", "nav_value": "Fotonenergí:  E = h · f = h·c / λ", "keywords": ["fotonenergi", "foton", "E=hf", "planck konstant", "fotonstråling", "bølgelængde foton energi"]},
    # Usikkerhed
    {"label": "Gennemsnit og stdafv. › Usikkerhed", "page": "pages/8_Usikkerhed.py", "nav_key": "usikk_formel", "nav_value": "Gennemsnit og standardafvigelse", "keywords": ["gennemsnit", "standardafvigelse", "statistik", "middelværdi", "spredning", "måleværdier"]},
    {"label": "Fejlpropagation › Usikkerhed", "page": "pages/8_Usikkerhed.py", "nav_key": "usikk_formel", "nav_value": "Fejlpropagation – generel (numerisk)", "keywords": ["fejlpropagation", "usikkerhed formel", "type A type B", "måleusikkerhed", "u(x)"]},
    {"label": "Potenslov-fitting › Usikkerhed", "page": "pages/8_Usikkerhed.py", "nav_key": "usikk_formel", "nav_value": "Potenslov-fitting:  y = A · xᵅ  (log-log regression)", "keywords": ["potenslov fitting", "log-log regression", "y=Axα", "eksponent fitting", "lineær regression log"]},
    # Rotation
    ...
    # Kollisioner
    {"label": "Elastisk kollision › Kollisioner", "page": "pages/10_Kollisioner.py", "nav_key": "koll_formel", "nav_value": "Elastisk kollision – 1D (KE bevaret)", "keywords": ["elastisk kollision", "KE bevaret", "elastisk stød", "hastighederne bytter", "bolde støder elastisk"]},
    {"label": "Uelastisk kollision › Kollisioner", "page": "pages/10_Kollisioner.py", "nav_key": "koll_formel", "nav_value": "Fuldstændig uelastisk kollision (objekter hænger sammen)", "keywords": ["uelastisk kollision", "klæber sammen", "fuldstændig uelastisk", "KE-tab kollision", "hænger sammen"]},
    {"label": "Eksplosion › Kollisioner", "page": "pages/10_Kollisioner.py", "nav_key": "koll_formel", "nav_value": "Eksplosion / udskydning", "keywords": ["eksplosion", "udskydning raket", "impulsbevarelse eksplosion", "dele flyver fra hinanden"]},
]
