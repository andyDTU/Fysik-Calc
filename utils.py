...
FORMLER = [
    ...
    {"navn": "Molekylær hastighed:  v_rms = √(3RT/M)",         "side": "Termodynamik", "fil": "pages/6_Termodynamik.py",     "key": "termo_formel", "kw": "molekylær hastighed vrms v_rms middelkvadrat Maxwell Boltzmann M molar gas T temperatur N2 O2 H2 He middelhastighed",  "vars": ["v", "T", "n", "m"]},
    # ── Atomfysik ──
    ...
    # ── Relativitetsteori ──
    {"navn": "Lorentz-faktor:  γ = 1 / √(1 − v²/c²)",          "side": "Relativitetsteori", "fil": "pages/12_Relativitetsteori.py", "key": "rel_formel", "kw": "Lorentz gamma beta v c relativitet faktor lorentz faktor tidsdilatation",                                                  "vars": ["γ", "v", "c"]},
