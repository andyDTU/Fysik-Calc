...
FORMLER = [
    ...
    {"navn": "Jævnt accelereret (1):  v = v₀ + a · t",         "side": "Kinematik",    "fil": "pages/1_Kinematik.py",        "key": "kin_formel",   "kw": "kinematik acceleration hastighed tid v v0 a t bremse bremsning opbremsning",                    "vars": ["v", "v₀", "a", "t"]},
    {"navn": "Jævnt accelereret (2):  s = v₀·t + ½·a·t²",     "side": "Kinematik",    "fil": "pages/1_Kinematik.py",        "key": "kin_formel",   "kw": "strækning position s v0 a t kinematik frit fald bremse bremseafstand",                           "vars": ["s", "v₀", "a", "t"]},
    {"navn": "Jævnt accelereret (3):  v² = v₀² + 2·a·s",      "side": "Kinematik",    "fil": "pages/1_Kinematik.py",        "key": "kin_formel",   "kw": "hastighed strækning v2 a s kinematik bremse bremselængde",                                        "vars": ["v", "v₀", "a", "s"]},
    ...
    {"navn": "Kastebevægelse (vandret kast)",                    "side": "Kinematik",    "fil": "pages/1_Kinematik.py",        "key": "kin_formel",   "kw": "kast vandret projektil horisontal vertikal højde bold kugle sten ramp",                       "vars": ["x", "h", "v₀", "t", "g"]},
    {"navn": "Kastebevægelse (skråt kast)",                     "side": "Kinematik",    "fil": "pages/1_Kinematik.py",        "key": "kin_formel",   "kw": "kast skråt vinkel projektil horisontal vertikal bold kugle sten football",                      "vars": ["x", "h", "v₀", "θ", "t", "g"]},
    ...
    # ── Atomfysik ──
    {"navn": "Radioaktivt henfald:  N = N₀ · e^(−λt)",        "side": "Atomfysik",    "fil": "pages/7_Atomfysik.py",        "key": "atom_formel",  "kw": "atom atomfysik radioaktiv henfald N N0 lambda t eksponentiel kerne nuklid",                   "vars": ["N", "λ", "t"]},
    ...
    {"navn": "Halvvejstid:  T½ = ln(2) / λ",                   "side": "Atomfysik",    "fil": "pages/7_Atomfysik.py",        "key": "atom_formel",  "kw": "atom atomfysik halvvejstid T halv lambda ln 2 henfald",                                          "vars": ["T½", "λ"]},
