...
FORMLER = [
    ...
    {"navn": "Jævnt accelereret (3):  v² = v₀² + 2·a·s",      "side": "Kinematik",    "fil": "pages/1_Kinematik.py",        "key": "kin_formel",   "kw": "hastighed strækning v2 a s kinematik bremse bremser bremselængde stopafstand ingen tid givet bil fartgrænse",                         "vars": ["v", "v₀", "a", "s"]},
    ...
    {"navn": "Cirkulær bevægelse – RPM-omregner og centripetal","side": "Kinematik",    "fil": "pages/1_Kinematik.py",        "key": "kin_formel",   "kw": "RPM cirkel centripetal omdrejning hastighed radius ac omregn centrifuge centrifugal",                                    "vars": ["ω", "r", "RPM"]},
    ...
    {"navn": "Normalkraft i sløjfe (top/bund)",                 "side": "Dynamik",      "fil": "pages/2_Dynamik.py",          "key": "dyn_formel",   "kw": "normalkraft sløjfe loop top bund minimum hastighed N vmin loop-the-loop cirkelbane lodret sløjfe minimum starthøjde h_min energibevarelse",  "vars": ["N", "F", "m", "v", "r", "g", "h"]},
    ...
    {"navn": "Spænding og tøjning:  σ = F / A",                "side": "Dynamik",      "fil": "pages/2_Dynamik.py",          "key": "dyn_formel",   "kw": "spænding tøjning youngs modul sigma epsilon E areal diameter stress strain kulfiber wire",                                    "vars": ["σ", "F", "A", "d"]},
    ...
    # ── Elektricitet ──
    {"navn": "Ohms lov:  U = R · I",                           "side": "Elektricitet", "fil": "pages/4_Elektricitet.py",     "key": "elek_formel",  "kw": "ohm spænding modstand strøm U R I volt ampere elektricitet kredsløb",                                                   "vars": ["U", "R", "I"]},
    ...
    {"navn": "Molekylær hastighed:  v_rms = √(3RT/M)",         "side": "Termodynamik", "fil": "pages/6_Termodynamik.py",     "key": "termo_formel", "kw": "molekylær hastighed vrms v_rms middelkvadrat Maxwell Boltzmann M molar gas T temperatur N2 O2 H2 He middelhastighed kinetisk gasteori rms kvadratisk middel",  "vars": ["v", "T", "n", "m", "E"]},
    # ── Atomfysik ──
    ...
    {"navn": "Energi-masse:  E = Δm · c²",                     "side": "Atomfysik",    "fil": "pages/7_Atomfysik.py",        "key": "atom_formel",  "kw": "atom atomfysik E mc2 masse energi Einstein delta m c MeV kerneenergi proton neutron elektron nukleon",                          "vars": ["E", "m", "c"]},
    ...
    {"navn": "Fuldstændig uelastisk kollision (objekter hænger sammen)", "side": "Kollisioner", "fil": "pages/10_Kollisioner.py", "key": "kol_formel", "kw": "uelastisk kollision fuldstændig hænger sammen klæber støder fast V m1 m2",                        "vars": ["m", "v", "v₀"]},
    {"navn": "Elastisk kollision – 1D (KE bevaret)",            "side": "Kollisioner",  "fil": "pages/10_Kollisioner.py",     "key": "kol_formel",   "kw": "elastisk kollision 1D KE bevaret v1 v2 masse støder fra hinanden spreder",                          "vars": ["m", "v", "v₀", "Ek"]},
    {"navn": "Kollision i 2D – vektorkomponenter",              "side": "Kollisioner",  "fil": "pages/10_Kollisioner.py",     "key": "kol_formel",   "kw": "kollision 2D vektor vinkel x y komponent",                                                         "vars": ["m", "v", "v₀", "θ"]},
    ...
    {"navn": "Simpelt pendul:  T = 2π√(L/g)",                  "side": "Svingninger",  "fil": "pages/11_Svingninger.py",     "key": "sving_formel", "kw": "pendul periode T L g svingning find g tyngdeacceleration mål eksperiment månen mars planet bestemmelse g fra pendul pendulmåling",  "vars": ["T", "L", "g", "f"]},
    ...
    # ── Relativitetsteori ──
    {"navn": "Lorentz-faktor:  γ = 1 / √(1 − v²/c²)",          "side": "Relativitetsteori", "fil": "pages/12_Relativitetsteori.py", "key": "rel_formel", "kw": "Lorentz gamma beta v c relativitet faktor lorentz faktor tidsdilatation relativitetsteori speciel relativitet Einstein",  "vars": ["γ", "v", "c"]},
    ...
    {"navn": "Relativistisk kinetisk energi:  Ek = (γ − 1) · m₀c²", "side": "Relativitetsteori", "fil": "pages/12_Relativitetsteori.py", "key": "rel_formel", "kw": "relativistisk kinetisk energi Ek gamma m0 c2 E=mc2 masseenergi",                        "vars": ["Ek", "γ", "m", "c"]},
    {"navn": "Relativistisk totalenergi:  E = γ · m₀c²",       "side": "Relativitetsteori", "fil": "pages/12_Relativitetsteori.py", "key": "rel_formel", "kw": "totalenergi E gamma m0 c2 hvileenergi E=mc2 masseenergi Einstein",                            "vars": ["E", "γ", "m", "c"]},
    ...
    },
    {
        ...
        "side": "Dimensionsanalyse",
        "fil": "pages/14_Dimensionsanalyse.py",
        "kw": "naturlig skala lambda tau pi-gruppe buckingham skalering model dimension dimensionsanalyse enhed M L T",
        "key": "dim_formel",
        "vars": [],
    },
    # ── Skalering ──
    {
        ...
        "kw": "skalering potenslov fordobling faktor T sqrt m k Kepler coulomb hastighed radius",
        "key": "skalering_formel",
        "vars": ["m", "k", "L", "r", "v"],
    },
    {
        "navn": "Skalering – fjeder og pendul",
        "side": "Skalering",
        "fil": "pages/15_Skalering.py",
        "kw": "fjeder masse periode T fordoble halvere skalering T proportional sqrt m k",
        "key": "skalering_formel",
        "vars": ["m", "k", "L", "T"],
    },
    {
        "navn": "Skalering – Kepler og gravitation",
        "side": "Skalering",
        "fil": "pages/15_Skalering.py",
        "kw": "Kepler planet satellit omløbstid radius r T kubed squared skalering gravitation",
        "key": "skalering_formel",
        "vars": ["r", "T", "M"],
    },
    # ── Elektricitet tilføjelser ──
    {
        "navn": "LC-kredsløb:  f₀ = 1/(2π√(LC))",
        "side": "Elektricitet",
        "fil": "pages/4_Elektricitet.py",
        "kw": "LC kredsløb resonans frekvens induktans kapacitans svingning oscillator radio",
        "key": "elek_formel",
        "vars": ["f", "L", "C"],
    },
    {
        "navn": "Kirchhoffs love (KCL + KVL)",
        "side": "Elektricitet",
        "fil": "pages/4_Elektricitet.py",
        "kw": "kirchhoff KCL KVL løkke strøm spænding knudepunkt netværk kredsløb løkkestrøm",
        "key": "elek_formel",
        "vars": ["U", "I", "R"],
    },
]
